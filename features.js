;(function(){function m(){var n=document.querySelector('#dc-root nav')||document.querySelector('nav');if(!n||document.getElementById('fws-metodo-link'))return;var a=document.createElement('a');a.id='fws-metodo-link';a.href='metodo.html';a.textContent='\uD83D\uDCD0 M\u00e9todo & N\u00fameros';a.title='Compilado das aulas 1 a 3, com os c\u00e1lculos conferidos';a.style.cssText='display:inline-flex;align-items:center;gap:6px;margin-left:8px;padding:6px 12px;border-radius:20px;background:transparent;border:1px solid #7B3B1E;color:#C9BFAF;font:600 13px Segoe UI,sans-serif;text-decoration:none';n.appendChild(a);}m();var rt2=document.getElementById('dc-root')||document.body;try{new MutationObserver(m).observe(rt2,{childList:true,subtree:true});}catch(e){}})();
